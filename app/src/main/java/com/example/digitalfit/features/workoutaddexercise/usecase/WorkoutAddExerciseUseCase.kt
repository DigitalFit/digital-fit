package com.example.digitalfit.features.workoutaddexercise.usecase
//
...
//
//class WorkoutAddExerciseUseCase(
//    private val application: Application
//) {
//
//    private val workoutAddExerciseRepository = WorkoutAddExerciseRepository(application)
//
...
//        return when (val responseApi = exercisesRepository.getInfoExercises(ConstantsApp.Exercise.FIRST_PAGE)) {
